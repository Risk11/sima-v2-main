...
const columns: ColumnDef<DataDuplikat>[] = [
  {
    id: 'no',
    header: 'No',
        ...
        <div className="">
          <div className="bg-white border border-[#E5E5E5] shadow-sm rounded-lg p-4 mx-5 my-5">
            <div className="flex justify-between items-center">
              <p className="font-semibold">Data Duplikat</p>
            ...
            <div className="mt-5">
                <div className="grid grid-cols-3 gap-4 scrollbar-hide">
                    <div className="grid col-span-2 scrollbar-hide">
                        <DataTable columns={columns} data={data} className='scrollbar-hide'/>
                    </div>
                    <div className="">
                        <p className='bg-slate-100 p-4 font-semibold rounded-md'>Peta Pelanggan</p>
                    </div>
                </div>
            </div>
          </div>
